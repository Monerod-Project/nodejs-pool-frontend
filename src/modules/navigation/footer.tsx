            ...
            <div className="relative bg-dracula-background border-t-4 border-neutral">
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="justify-between items-center py-4 md:justify-start md:space-x-10">
                        ...
                        <a href="https://github.com/Monerod-org" target="_blank" rel="noreferrer" className="text-indigo-400"><SiGithub title="View our Code Repositories" size={35} style={{margin: '0 auto', display: 'inline-block', padding: '5px'}}/></a>
                        ...
                        2021-2022 MonerodProject | <a href="https://git.monerod.org/monerodproject/nodejs-pool-frontend" target="_blank" rel="noreferrer" className="text-indigo-400">v1.6.0</a> | We are in no way affiliated with the good folks at <a href="https://getmonero.org" target="_blank" rel="noreferrer" className="text-indigo-400">GetMonero.org</a><br />
                        <span className="text-xs">
                        Frontend: <a href="https://github.com/Monerod-org/nodejs-pool-frontend" target="_blank" rel="noreferrer" className="text-indigo-400">Monerod</a>/<a href="https://github.com/provsalt/beast-oss" target="_blank" rel="noreferrer" className="text-indigo-400">provsalt</a> | 
                        Pool: <a href="https://github.com/Monerod-org/nodejs-pool" target="_blank" rel="noreferrer" className="text-indigo-400">Monerod</a>/<a href="https://github.com/MoneroOcean/nodejs-pool" target="_blank" rel="noreferrer" className="text-indigo-400">MoneroOcean</a> | 
                        Bonus Hashrate: <a href="https://github.com/Monerod-org/nodejs-pool-bonus-hashrate" target="_blank" rel="noreferrer" className="text-indigo-400">Monerod</a>/<a href="https://github.com/fallacy-xmr/hashrate-bonus" target="_blank" rel="noreferrer" className="text-indigo-400">fallacy</a> | 
                        ...
                        Discord Bot: <a href="https://github.com/Monerod-org/nodejs-pool-discord-bot" target="_blank" rel="noreferrer" className="text-indigo-400">Monerod</a>/<a href="https://github.com/fallacy-xmr/pool-discord-bot" target="_blank" rel="noreferrer" className="text-indigo-400">fallacy</a> | 
                        XMRig-md: <a href="https://github.com/Monerod-org/xmrig-md" target="_blank" rel="noreferrer" className="text-indigo-400">Monerod</a>/<a href="https://github.com/xmrig/xmrig" target="_blank" rel="noreferrer" className="text-indigo-400">XMRig</a>
                        </span>
                        </p>
                    </div>
                </div>
